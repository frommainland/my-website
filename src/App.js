...
//work 2026
import Hairlet from './works/Hairlet'
import Warkday from './works/Warkday'
			...
			<NavButtonContext.Provider
				...
				<Routes>
					...
					<Route
						...
						{/* 2026 */}
                        <Route path="Warkday" element={<Warkday />} />
						<Route path="Hairlet" element={<Hairlet />} />
						...
						<Route
							path="RadiantCanvas"
							element={<RadiantCanvas />}
						/>
						<Route
							path="HarpersCollection"
							element={<HarpersCollection />}
						/>
						<Route
							path="EmojiWallpaper"
							element={<EmojiWallpaper />}
						/>
						<Route
							path="FramerMotionBook"
							element={<FramerMotionBook />}
						/>

						<Route
							path="LinkedinJobExplore"
							element={<LinkedinJobExplore />}
						/>
						<Route
							path="FlowerAndPoem"
							element={<FlowerAndPoem />}
						/>
						<Route path="SlackingOff" element={<SlackingOff />} />

						<Route path="Multicard" element={<MultiCard />} />
						<Route
							path="RumbleInTheJungle"
							element={<RumbleInTheJungle />}
						/>
